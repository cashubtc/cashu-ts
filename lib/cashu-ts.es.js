...
import { cairoProveProofs as ee } from "./crypto/client/NUTXX.es.js";
function se(n) {
...
function Ut(n) {
  ...
  return oe(X.from(t).toString("base64"));
}
function ne(n) {
  const t = X.from(re(n), "base64").toString();
  return JSON.parse(t);
}
function re(n) {
...
function ue(n, t) {
  ...
  Ot(e.length, t), t[t.length - 1] |= 160;
  for (const s of e)
    Nt(s, t), kt(n[s], t);
}
function bt(n) {
...
function Ee(n, t) {
  ...
  return n.unit && (e.unit = n.unit), n.memo && (e.memo = n.memo), ke + we + Ut(e);
}
function Ze(n, t) {
  if (Ct(n.proofs) || t?.version === 3) {
    if (t?.version === 4)
      throw new Error("can not encode to v4 token if proofs contain non-hex keyset id");
    return Ee(n, t?.removeDleq);
  }
...
function Ae(n, t) {
  if (t && (n.proofs = ht(n.proofs)), n.proofs.forEach((c) => {
    ...
    throw new Error("can not encode to v4 token if proofs contain non-hex keyset id");
  const s = Wt(n), r = wt(s), o = "cashu", i = "B", a = se(r);
  return o + i + a;
}
function Wt(n) {
  const t = {}, e = n.mint;
...
function qt(n) {
  return Ie(n.keys) === n.id;
}
function Ie(n) {
  const t = Object.entries(n).sort((r, o) => +r[0] - +o[0]).map(([, r]) => $(r)).reduce((r, o) => Me(r, o), new Uint8Array()), e = Vt(t);
...
class De {
  constructor(t, e) {
    this.subListeners = {}, this.rpcListeners = {}, this.rpcId = 0, this.onCloseCallbacks = [], this._WS = xe(), this.url = new URL(t), this.messageQueue = new Te(), this._logger = e ?? W;
  }
  connect() {
...
class U {
   ...
   */
  async getInfo() {
    return U.getInfo(this._mintUrl, this._customRequest, this._logger);
  }
  async getLazyMintInfo() {
    if (this._mintInfo)
      return this._mintInfo;
    const t = await U.getInfo(this._mintUrl, this._customRequest);
  ...
  static async swap(t, e, s, r) {
    const o = s || K, i = r ? { "Blind-auth": r } : {}, a = await o({
  ...
  async swap(t) {
    ...
    return U.swap(this._mintUrl, t, this._customRequest, e);
  }
  /**
  ...
  static async createMintQuote(t, e, s, r, o) {
    const i = o ?? W, a = s || K, c = r ? { "Blind-auth": r } : {}, u = await a({
  ...
  async checkMintQuote(t) {
    ...
    return U.checkMintQuote(this._mintUrl, t, this._customRequest, e);
  }
  /**
  ...
  async mint(t) {
    ...
    return U.mint(this._mintUrl, t, this._customRequest, e);
  }
  /**
  ...
  async checkMeltQuote(t) {
    ...
    return U.checkMeltQuote(this._mintUrl, t, this._customRequest, e);
  }
  /**
  ...
  async melt(t) {
    ...
    return U.melt(this._mintUrl, t, this._customRequest, e);
  }
  /**
   ...
   */
  async getKeySets() {
    return U.getKeySets(this._mintUrl, this._customRequest);
  }
  /**
   * Checks if specific proofs have already been redeemed.
   *
   ...
   */
  async check(t) {
    return U.check(this._mintUrl, t, this._customRequest);
  }
  ...
  async restore(t) {
    return U.restore(this._mintUrl, t, this._customRequest);
  }
  /**
...
class L {
  ...
  static createP2PKData(t, e, s, r) {
    return D(e, s.keys, r).map((i) => this.createSingleP2PKData(t, i, s.id));
  }
  static createCairoData(t, e, s, r) {
    return D(e, s.keys, r).map((i) => this.createSingleCairoData(t, i, s.id));
  }
  ...
  static createRandomData(t, e, s) {
    return D(t, e.keys, s).map((o) => this.createSingleRandomData(o, e.id));
  }
  ...
  static createDeterministicData(t, e, s, r, o) {
    return D(t, r.keys, o).map(
      (a, c) => this.createSingleDeterministicData(a, e, s + c, r.id)
    );
  }
  static createSingleDeterministicData(t, e, s, r) {
    const o = Zt(e, r, s), i = G(o), a = new TextEncoder().encode(i), c = be(te(e, r, s)), { r: u, B_: h } = ot(a, c);
    return new L(
...
class is {
   ...
   */
  constructor(t, e) {
    this._keys = /* @__PURE__ */ new Map(), this._keysets = [], this._seed = void 0, this._unit = Be, this._mintInfo = void 0, this._denominationTarget = Fe, this.mint = t, this._logger = e?.logger ?? W;
    let s = [];
  ...
  async receive(t, e) {
    ...
    const w = await this.createSwapPayload(
      ...
      h,
      l
    ), { signatures: k } = await this.mint.swap(w.payload), E = w.outputData.map((O, x) => O.toProof(k[x], d)), q = [];
    return w.sortedIndices.forEach((O, x) => {
      q[O] = E[x];
    }), q;
  }
  /**
  ...
  selectProofsToSend(t, e, s = !1) {
    ...
    for (let p = 0; p < 60; p++) {
      ...
      if (P < d) {
        ...
        const v = [...l];
        for (; v.length > 1 && d > 0; ) {
          const F = v.pop(), B = y - F.proof.amount, j = g - F.ppkfee, z = O(B, j);
          if (z == 1 / 0) break;
  ...
  async swap(t, e, s) {
    ...
    let k = t;
    const E = H(e);
    let q = r?.sendAmounts || D(k, w.keys);
    if (o) {
      let A = this.getFeesForKeyset(q.length, w.id), P = D(A, w.keys);
      for (; this.getFeesForKeyset(q.concat(P).length, w.id) > A; )
        A++, P = D(A, w.keys);
      q = q.concat(P), k += A;
    }
    const { keep: O, send: x } = this.selectProofsToSend(
      e,
      k,
      !0
      // inc. fees
  ...
  async mintProofs(t, e, s) {
    ...
    if (h)
      if (mt(h)) {
        const k = D(t, d.keys, r?.keepAmounts);
  ...
  async createSwapPayload(t, e, s, r, o, i, a, c, u, h, l) {
    ...
    r && r.sendAmounts && !r.keepAmounts && (r.keepAmounts = D(
    ...
    ], O = E.map((_) => k[_]), x = E.map((_) => q[_]);
    return {
      payload: {
        inputs: e,
        outputs: O.map((_) => _.blindedMessage)
      },
      outputData: O,
      keepVector: x,
      sortedIndices: E
  ...
  createOutputData(t, e, s, r, o, i, a, c) {
    ...
    } else i ? u = L.createP2PKData(i, t, e, o) : a ? u = L.createCairoData(a, t, e, o) : c ? u = D(t, e.keys).map((l) => c(l, e)) : u = L.createRandomData(t, e, o);
    return u;
  }
  /**
...
async function as(n, t, e) {
  const s = new Z(t);
  return (await new Le(s).mintProofs(n, e)).map((i) => Ce(i));
}
export {
  Z as CashuAuthMint,
  ...
  Re as PaymentRequestTransportType,
  ts as decodePaymentRequest,
  Ie as deriveKeysetId,
  as as getBlindedAuthToken,
  Se as getDecodedToken,
  ss as getDecodedTokenBinary,
  Ce as getEncodedAuthToken,
  Ze as getEncodedToken,
  es as getEncodedTokenBinary,
  Ae as getEncodedTokenV4,
  $t as hasValidDleq,
  ns as injectWebSocketImpl,
  os as setGlobalRequestOptions
};
