...
describe("test decode token", () => {
    test("testing v1 Token", () => {
        ...
        expect(result.proofs.reduce((c, p) => { return c + p.amount }, 0)).toEqual(100)
    ...
    test("testing v2 Token", async () => {
        const token = ""
    ...
    test("testing v2 Token 2", () => {
        const token = ""
    ...
    test("test corrupt v2 token", () => {
        const token = ""
...
describe("test encode token", () => {
    test("testing v2 Token", async () => {
        ...
        const obj = {
            proofs: [
                new Proof("I2yN+iRYfkzT", 1, "97zfmmaGf5k8Mg0gajpnbmpervTtEeE8wwKri7rWpUs=", "02195081e622f98bfc19a05ebe2341d955c0d12588c5948c858d07adec007bc1e4")
            ],
            mints: [{ url: "https://8333.space:3338", ids: ["L3zxxRB/I8uE", "I2yN+iRYfkzT"] }]
        }
