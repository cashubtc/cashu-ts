...
const projectRoot = path.resolve(__dirname, '../..'); // From test/consumer-bundler/ to root

async function runBundlerTest() {
	...
	try {
		...
		console.log('Bundler test passed!');
	} catch (error) {
		console.error('Bundler test failed:', error);
		process.exit(1);
	} finally {
