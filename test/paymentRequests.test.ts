...
import { decodePaymentRequest, PaymentRequest, PaymentRequestPayload, PaymentRequestTransport, PaymentRequestTransportType } from '../src/index.js';

describe('payment requests', () => {
    test('encode payment requests', async () => {
        const request = new PaymentRequest(
            [{ type: PaymentRequestTransportType.NOSTR, target: "asd", tags: [["n", "17"]] } as PaymentRequestTransport],
            '4840f51e',
            1000,
            'sat',
            ["https://mint.com"],
    ...
    test('test decoding payment requests with no amount', async () => {
        const prWithoutAmount = '';
        ...
        expect(request.transport[0].target).toBe('nprofile1qy28wumn8ghj7un9d3shjtnyv9kh2uewd9hsz9mhwden5te0wfjkccte9curxven9eehqctrv5hszrthwden5te0dehhxtnvdakqqgymdex3gvfsfujp3xyn7e7qrs8yyq9d8zsu2zqujxuxcapfqvzc8grqdkts')
    });
});
