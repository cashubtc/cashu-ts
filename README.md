...
[![codecov](https://codecov.io/gh/cashubtc/cashu-ts/graph/badge.svg)](https://codecov.io/gh/cashubtc/cashu-ts)
...
> **ESM-only since v4.** This package ships only ES modules. CommonJS `require()` is no longer supported. If upgrading from v3, see [migration-4.0.0.md](./migration-4.0.0.md).
...
- Start by reading [COMMUNITY.md](./COMMUNITY.md) to understand our contribution philosophy, review expectations, and how to get involved.
