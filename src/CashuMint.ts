...
class CashuMint {
	...
	public static async mint(
		...
		try {
			const res = await fetch(`${mintUrl}/mint?hash=${hash}`, {method: 'POST', body: JSON.stringify(payloads), headers: new Headers({'content-type': 'application/json'})})
	...
	public static async split(mintUrl: string, splitPayload: SplitPayload): Promise<SplitResponse> {
		try {
			const res = await fetch(`${mintUrl}/split`, {method: 'POST', body: JSON.stringify(splitPayload),headers: new Headers({'content-type': 'application/json'})})
	...
	public static async melt(mintUrl: string, meltPayload: MeltPayload): Promise<MeltResponse> {
		try {
			const res = await fetch(`${mintUrl}/melt`, {method: 'POST', body: JSON.stringify(meltPayload), headers: new Headers({'content-type': 'application/json'})})
	...
	public static async checkFees(
		...
		try {
			const res = await fetch(`${mintUrl}/checkfees`, {method: 'POST', body: JSON.stringify(checkfeesPayload),headers: new Headers({'content-type': 'application/json'})})
	...
	public static async check(
		...
		try {
			const res = await fetch(`${mintUrl}/check`, {method: 'POST', body: JSON.stringify(checkPayload),headers: new Headers({'content-type': 'application/json'})})
