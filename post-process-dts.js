...
try {
	...
	ensureFile(
		path.join(typesDir, 'crypto/client/index.d.ts'),
		`export * from '../client';\nexport {};\n`,
	);
	ensureFile(
		path.join(typesDir, 'crypto/common/index.d.ts'),
		`export * from '../common';\nexport {};\n`,
	);
	ensureFile(
		path.join(typesDir, 'crypto/mint/index.d.ts'),
		`export * from '../mint';\nexport {};\n`,
	);
	...
	ensureFile(
		path.join(typesDir, 'crypto/util/index.d.ts'),
		`export * from '../util';\nexport {};\n`,
	);
	ensureFile(
		path.join(typesDir, 'crypto/util/utils.d.ts'),
		`export * from '../../util';\nexport {};\n`,
	);
} catch (error) {
