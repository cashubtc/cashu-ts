...
verifiers do not need a hash library of their own. `sha256` takes raw bytes; for UTF-8
message strings use `computeMessageDigest` instead. `taggedHash` is the BIP340
